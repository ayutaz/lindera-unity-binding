...
namespace Lindera
{
    ...
    public static unsafe class NativeMethods
    {
        ...
        {
            NativeMethodsGenerated.lindera_tokenizer_destroy((LinderaTokenizer*)handle);
        }
        ...
        {
            return NativeMethodsGenerated.lindera_tokens_count((TokenResult*)handle);
        }
        ...
        public static TokenData* lindera_tokens_get(IntPtr handle, int index)
        {
            return NativeMethodsGenerated.lindera_tokens_get((TokenResult*)handle, index);
        }
        ...
        {
            NativeMethodsGenerated.lindera_tokens_destroy((TokenResult*)handle);
        }
